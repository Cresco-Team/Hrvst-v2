    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex flex-col gap-6 p-4 lg:p-6">
            ...
            <Deferred data="kpis">
                ...
                <div class="grid md:grid-cols-3 gap-4">
                    <LargeCard title="Total Varieties" subtext="recorded" :value="kpis?.varieties.total_varieties.value"
                    ...
                    <LargeCard title="Total Farmers" subtext="registered" :value="kpis?.farmers.total_farmers.value"
                    ...
                    <LargeCard title="Total Dealers" subtext="registered" :value="kpis?.dealers.total_dealers.value"
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <SmallCard title="Total Farmer Supplies" :value="kpis?.farmers.total_supplies.value" />
                    <SmallCard title="Total Dealer Demands" :value="kpis?.dealers.total_demands.value" />
                    <SmallCard title="Updated This Week" :value="kpis?.varieties.price_updates_week.value" />
                    <SmallCard title="Stale Vegetables" :value="kpis?.varieties.needs_attention.value" />
                </div>
            </Deferred>
            ...
            <Card>
                ...
                <CardContent class="grid md:grid-cols-3 gap-4">
                    ...
                    <QuickNavItem :href="dealers.index()" title="Dealers" description="Track Activity" :icon="Package"
                        colorClasses="from-sky-500/10 to-blue-500/10" iconClasses="text-blue-600 dark:text-blue-500" />
                </CardContent>
            </Card>
        </div>
    </AppLayout>
