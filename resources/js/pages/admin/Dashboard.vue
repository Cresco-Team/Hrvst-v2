        ...
        <AppContent variant="header" class="p-4 lg:p-6">
            <div class="flex flex-col gap-6">
                ...
                <div class="grid auto-rows-auto gap-4 md:grid-cols-6 lg:grid-cols-12">
                    ...
                    <div class="group relative overflow-hidden rounded-xl border bg-gradient-to-br from-blue-500/10 via-purple-500/10 to-pink-500/10 p-6 shadow-sm transition-all hover:shadow-md md:col-span-3 lg:col-span-4">
                    ...
                    <div class="group relative overflow-hidden rounded-xl border bg-gradient-to-br from-green-500/10 via-emerald-500/10 to-teal-500/10 p-6 shadow-sm transition-all hover:shadow-md md:col-span-3 lg:col-span-4">
                    ...
                    <div class="relative overflow-hidden rounded-xl border border-orange-200 bg-gradient-to-br from-orange-500/10 to-amber-500/10 p-5 shadow-sm transition-all hover:shadow-md dark:border-orange-900/50 md:col-span-3 lg:col-span-4">
                        <div class="space-y-2">
