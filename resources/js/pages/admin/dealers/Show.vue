...
import type { BreadcrumbItem, PostItemSnapshot, DealerResource } from '@/types'
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex flex-col gap-6 p-4 lg:p-6">
            ...
            <Deferred data="dealer">
                ...
                <!-- was: grid grid-cols-12 — breaks below lg, col-span-3/9 invisible on mobile -->
                <div
                    v-if="dealer"
                ...
                >
                    ...
                    <Card class="w-full space-y-5 p-5 lg:w-72 lg:shrink-0">
                        ...
                        <div class="space-y-2.5 text-sm text-muted-foreground">
                            ...
                            <div class="flex items-center gap-2">
                                <CalendarDays class="size-4 shrink-0" /><span
                                    >Joined {{ dealer.joined_at_human }}</span
                                >
                            </div>
                        </div>
                    </Card>
