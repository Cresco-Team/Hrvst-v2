...
import type {
  BreadcrumbItem,
  DealerSupplyMapProps,
  SupplyMapFilters,
  SupplyMarker,
} from '@/types'

defineProps<DealerSupplyMapProps>()

const breadcrumbs: BreadcrumbItem[] = [
  { title: 'Dealer', href: dealer.demands.index().url },
  { title: 'Supply Map', href: dealer.supplyMap.index().url },
]
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="flex flex-col gap-6 p-4 lg:p-6">
      ...
      <Heading title="Supply Distribution Map"
        description="Explore where vegetables are being grown and find potential suppliers near you." />
