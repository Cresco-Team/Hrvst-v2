        ...
        <form class="flex flex-col gap-6" @submit.prevent="submit">
            ...
            <div class="grid gap-2">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <button type="button" class="rounded-md border px-4 py-3 text-sm font-medium transition-colors"
            ...
            <div class="grid gap-4">
                ...
                <div class="grid gap-2">
                    ...
                    <Input id="email" v-model="form.email" type="email" required :tabindex="2" autocomplete="email"
                ...
                <div class="grid gap-2">
                    ...
                    <Input id="phone_number" v-model="form.phone_number" type="tel" required :tabindex="3"
                        autocomplete="tel" placeholder="09171234567" />
                    <InputError :message="form.errors.phone_number" />
                </div>

                <div class="grid gap-2">
                    <Label for="password">Password</Label>
                    <Input id="password" v-model="form.password" type="password" required :tabindex="4"
                ...
                <div class="grid gap-2">
                    ...
                    <Input id="password_confirmation" v-model="form.password_confirmation" type="password" required
                        :tabindex="5" autocomplete="new-password" placeholder="Confirm password" />
                ...
                <div class="grid gap-2">
                    ...
                    <div class="flex items-center gap-3">
                        <img v-if="previews.profile_image" :src="previews.profile_image" alt="Profile preview"
                            class="size-12 rounded-full border object-cover" />
                        <Input id="profile_image" type="file" accept="image/jpeg,image/jpg,image/png,image/webp"
                            :tabindex="6" class="cursor-pointer" @change="handleFileSelect($event, 'profile_image')" />
                    </div>
            ...
            <template v-if="form.role === 'farmer'">
                <div class="grid gap-4 rounded-md border p-4">
                    ...
                    <div class="grid gap-2">
                        ...
                        <Select :model-value="form.municipality_id?.toString() ?? ''"
                            @update:model-value="onMunicipalityChange">
                            <SelectTrigger id="municipality_id">
                                <SelectValue placeholder="Select municipality" />
                            </SelectTrigger>
                            <SelectContent>
                                <SelectItem v-for="m in municipalities" :key="m.id" :value="m.id.toString()">
                                    {{ m.name }}
                                </SelectItem>
                            </SelectContent>
                        </Select>
                    ...
                    <div class="grid gap-2">
                        ...
                        <Select :model-value="form.barangay_id?.toString() ?? ''"
                            ...
                            <SelectContent>
                                <SelectItem v-for="b in barangays" :key="b.id" :value="b.id.toString()">
                                    {{ b.name }}
                                </SelectItem>
                            </SelectContent>
                        </Select>
                    ...
                    <div class="grid gap-2">
                        ...
                        <FarmLocationPicker :municipality-coords="mapCenter"
                            :model-value="{ lat: form.latitude, lng: form.longitude }" :lat-error="form.errors.latitude"
                    ...
                    <div class="grid gap-2">
                        ...
                        <div class="grid gap-2">
                            <img v-if="previews.farm_image" :src="previews.farm_image" alt="Farm preview"
                                class="h-32 w-full rounded-md border object-cover" />
                            <Input id="farm_image" type="file" accept="image/jpeg,image/jpg,image/png,image/webp"
                                class="cursor-pointer" @change="handleFileSelect($event, 'farm_image')" />
                        </div>
            ...
            <template v-if="form.role === 'dealer'">
                <div class="grid gap-4 rounded-md border p-4">
                    ...
                    <div class="grid gap-2">
                        ...
                        <div class="grid gap-2">
                            <img v-if="previews.document_image" :src="previews.document_image" alt="Document preview"
                                class="h-32 w-full rounded-md border object-cover" />
                            <Input id="document_image" type="file" accept="image/jpeg,image/jpg,image/png,image/webp"
                                class="cursor-pointer" @change="handleFileSelect($event, 'document_image')" />
                        </div>
                        <p class="text-xs text-muted-foreground">
            ...
            <!-- Submit -->
            <Button type="submit" class="w-full" :tabindex="7" :disabled="form.processing || form.role === ''"
