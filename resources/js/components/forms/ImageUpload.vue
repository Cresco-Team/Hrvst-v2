...
<template>
    <div class="flex flex-col gap-2">
        ...
        <div v-if="!hasImage"
            ...
            <input ref="fileInput" type="file" accept="image/jpeg,image/png,image/jpg,image/webp" class="hidden"
                @change="handleFileSelect" />
        </div>

        <!-- Preview Area -->
        <div v-else class="relative overflow-hidden rounded-lg border">
            <img :src="previewUrl!" alt="Variety preview" class="h-48 w-full object-cover" />
            <div
                ...
                <Button type="button" variant="destructive" size="sm" @click="clearImage">
