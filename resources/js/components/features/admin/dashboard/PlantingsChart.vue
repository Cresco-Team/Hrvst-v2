            ...
            plugins: {
                ...
                tooltip: {
                    ...
                    callbacks: {
                        ...
                        label: (item) => `${item.parsed.y} plantings`
                    }
                }
            },
            scales: {
    ...
    <div class="group rounded-xl border bg-card shadow-sm transition-all hover:shadow-md">
        <div class="border-b bg-muted/30 p-4">
            <div class="flex items-center gap-2">
                <Sprout class="size-4 text-green-600 dark:text-green-500" />
                <div>
                    <h3 class="font-semibold">Plantings Timeline</h3>
                    <p class="text-xs text-muted-foreground">30-day planting activity</p>
                </div>
            </div>
        </div>
        <div class="p-6">
