...
<template>
    <Item
        ...
        :class="[
            ...
            supply.needs_action ? 'border-l-4 border-l-destructive bg-destructive/5' : 'bg-primary/10',
        ]"
    >
        ...
        <ItemContent>
            <ItemTitle class="flex flex-wrap items-center gap-1.5">
                ...
                <Badge v-if="supply.needs_action" variant="destructive">Action needed</Badge>
            </ItemTitle>
                    ...
                    <div class="divide-y">
                        ...
                        >
                            ...
                            <PostActionButtons
                                ...
                                :only="['needsAction']"
                            />
                            <Badge v-else-if="supply.needs_action" variant="secondary" class="shrink-0 capitalize">
                                {{ item.status }}
                            </Badge>
                        </div>
                    </div>
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuGroup>
                        ...
                        <DropdownMenuItem class="text-destructive focus:text-destructive" @click="emit('delete', supply)">
                            <Trash />
                            Delete Supply
                        </DropdownMenuItem>
                    </DropdownMenuGroup>
