...
<template>
    <Card
        as="div"
        class="h-full gap-0 overflow-hidden py-0 transition-all hover:-translate-y-0.5 hover:shadow-lg"
    >
        <Link :href="href" class="block">
            ...
            >
                <img
                    v-if="variety.vegetable.image_url"
                    :src="variety.vegetable.image_url"
        ...
        <CardContent class="flex flex-col gap-1.5 px-3 py-2 sm:px-4 sm:py-3">
            <template v-if="hasPrice">
                <div class="flex items-center gap-1.5 font-mono">
                    ...
                    />
                    <AppTooltip
                        :content="`${variety.latest_price!.freshness} price since ${variety.price_updated_date}`"
                    >
                ...
                <div class="flex items-center gap-1.5">
                    ...
                    <AppTooltip :content="variety.price_updated_date ?? ''">
                        <span class="cursor-help text-xs">{{
                            variety.price_updated_human
                        }}</span>
                    </AppTooltip>
                </div>
            </template>
            ...
            <div class="flex items-center justify-end pt-0.5">
                ...
                <AppTooltip content="Likes">
                    <span class="cursor-help text-xs tabular-nums">{{
                        localCount
                    }}</span>
                </AppTooltip>
            </div>
