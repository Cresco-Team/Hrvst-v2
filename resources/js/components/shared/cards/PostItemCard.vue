...
<template>
    ...
    >
        ...
        >
            ...
            >
                {{
                    item.days_until_transaction <= 0
                        ? 'Today'
                        : `${item.days_until_transaction}d away`
                }}
            </div>
        ...
        <CardHeader class="px-4 pt-3 pb-1">
            <CardTitle class="line-clamp-1 text-sm leading-tight sm:text-base">
                {{ item.name }}
            </CardTitle>
