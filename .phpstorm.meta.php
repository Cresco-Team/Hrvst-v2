...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.disks.documents.driver' => 'string',
            'filesystems.disks.documents.root' => 'string',
            'filesystems.disks.documents.throw' => 'boolean',
...
'viewAny','view','update','delete','restore',
'forceDelete','create','archive','fulfill',);
...
'filesystems.disks.s3.report','filesystems.disks.documents.driver','filesystems.disks.documents.root','filesystems.disks.documents.throw','filesystems.links.C:\\Users\\user\\Herd\\Hrvst-v2\\public\\storage',
...
'two-factor.secret-key','two-factor.recovery-codes','two-factor.regenerate-recovery-codes','home',
'address.barangays','change-pin.show','change-pin.update','varieties.heart.toggle','posts.heart.toggle',
'dashboard','dev.login.admin','dev.login.farmer','dev.login.dealer',
'profile.edit','profile.update','profile.destroy','user-password.edit','user-password.update',
'appearance.edit','two-factor.show','admin.dashboard','admin.users.farmers.create','admin.users.farmers.store',
'admin.users.dealers.create','admin.users.dealers.store','admin.users.reset-pin','admin.vegetables.index','admin.vegetables.details',
'admin.vegetables.show','admin.vegetables.store','admin.vegetables.update','admin.vegetables.prices.store','admin.vegetables.destroy',
'admin.farmers.index','admin.farmers.show','admin.farmers.destroy','admin.farmers.api.markers','admin.farmers.api.details',
'admin.dealers.index','admin.dealers.show','admin.dealers.document','admin.dealers.destroy','admin.dealers.api.details',
'farmer.vegetables.index','farmer.vegetables.show','farmer.supplies.index','farmer.supplies.store','farmer.supplies.update',
'farmer.supplies.archive','farmer.supplies.fulfill','farmer.supplies.destroy','farmer.supply-map.index','farmer.supply-map.markers',
'farmer.marketplace.index','dealer.vegetables.index','dealer.vegetables.show','dealer.demands.index','dealer.demands.store',
'dealer.demands.update','dealer.demands.archive','dealer.demands.fulfill','dealer.demands.destroy','dealer.supply-map.index',
'dealer.supply-map.markers','dealer.marketplace.index','storage.local','storage.local.upload',);
