...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'ai.providers.anthropic.key' => 'string',
            ...
            'ai.providers.openai.key' => 'string',
            ...
            'ai.providers.voyageai.key' => 'string',
            'ai.providers.xai.driver' => 'string',
            'ai.providers.xai.key' => 'string',
            'app.name' => 'string',
            'app.env' => 'string',
            'app.debug' => 'boolean',
            'app.url' => 'string',
            ...
            'filesystems.links.C:\Users\user\Herd\Hrvst-v2\public\storage' => 'string',
...
'not-admin','viewAny','view','update','delete',
'restore','forceDelete','create','harvest','archive',
'fulfill',);
...
'ai.providers.anthropic.url','ai.providers.azure.driver','ai.providers.azure.key','ai.providers.azure.url','ai.providers.azure.api_version',
...
'ai.providers.mistral.driver','ai.providers.mistral.key','ai.providers.ollama.driver','ai.providers.ollama.key','ai.providers.ollama.url',
...
'ai.providers.voyageai.driver','ai.providers.voyageai.key','ai.providers.xai.driver','ai.providers.xai.key','app.name',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\user\\Herd\\Hrvst-v2\\public\\storage','fortify.guard',
...
'mcp.authorization_server','nightwatch.enabled','nightwatch.token','nightwatch.deployment','nightwatch.server',
...
'nightwatch.ingest.timeout','nightwatch.ingest.connection_timeout','nightwatch.ingest.event_buffer','prism.prism_server.middleware','prism.prism_server.enabled',
...
'prism.providers.perplexity.url','prism.providers.z.url','prism.providers.z.api_key','ide-helper.filename','ide-helper.models_filename',
...
'signed','throttle','verified','admin','farmer',
'dealer',);
        registerArgumentsSet('routes', 
'boost.browser-logs','login','login.store','logout','user-profile-information.update',
...
'two-factor.recovery-codes','two-factor.regenerate-recovery-codes','home','address.barangays',
'change-pin.show','change-pin.update','varieties.heart.toggle','posts.heart.toggle','dashboard',
'dev.login.admin','dev.login.farmer','dev.login.dealer','profile.edit',
'profile.update','profile.destroy','profile.avatar.update','appearance.edit','two-factor.show',
'admin.dashboard','admin.users.farmers.create','admin.users.farmers.store','admin.users.dealers.create','admin.users.dealers.store',
'admin.users.reset-pin','admin.categories.index','admin.vegetables.index','admin.vegetables.store','admin.vegetables.update',
'admin.vegetables.destroy','admin.vegetables.varieties.show','admin.vegetables.varieties.store','admin.vegetables.varieties.update','admin.vegetables.varieties.prices.store',
'admin.vegetables.varieties.destroy','admin.farmers.index','admin.farmers.show','admin.farmers.destroy','admin.farmers.api.markers',
'admin.farmers.api.details','admin.dealers.index','admin.dealers.show','admin.dealers.destroy','admin.dealers.api.details',
'farmer.dashboard','farmer.supplies.index','farmer.supplies.store','farmer.supplies.update','farmer.supplies.harvest',
'farmer.supplies.destroy','farmer.post-items.update','farmer.post-items.fulfill','farmer.post-items.archive','farmer.post-items.destroy',
'farmer.supply-map.index','farmer.supply-map.markers','farmer.marketplace.index','dealer.dashboard','dealer.demands.index',
'dealer.demands.store','dealer.demands.update','dealer.demands.destroy','dealer.post-items.update','dealer.post-items.fulfill',
'dealer.post-items.archive','dealer.post-items.destroy','dealer.supply-map.index','dealer.supply-map.markers','dealer.marketplace.index',
'categories','vegetables.index','vegetables.show','storage.local','storage.local.upload',);
...
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.Users.user.Herd.Hrvst-v2.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','NIGHTWATCH_TOKEN','NIGHTWATCH_REQUEST_SAMPLE_RATE',
'LOG_CHANNEL','LOG_STACK','ADMIN_PASSWORD','ANTHROPIC_API_KEY','COHERE_API_KEY',
'ELEVENLABS_API_KEY','GEMINI_API_KEY','MISTRAL_API_KEY','OLLAMA_API_KEY','OPENAI_API_KEY',
'JINA_API_KEY','VOYAGEAI_API_KEY','XAI_API_KEY',);
