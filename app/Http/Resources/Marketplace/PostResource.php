...
class PostResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'vegetable' => $this->whenLoaded('vegetable', fn () => new VegetableResource($this->vegetable)),

            'items' => $this->whenLoaded('postItems', fn () => PostItemResource::collection($this->postItems)),
        ];
    }
}
